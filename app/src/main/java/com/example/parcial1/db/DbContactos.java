...
public class DbContactos extends DbHelper{
    ...
    public long insetarContacto(String user, String producto, double precio){
    ...
    public ArrayList<Contactos> mostrarContactos(){
        ...
        if (cursorContactos.moveToFirst()){
            do {
                ...
                contacto.setPrecio(Double.parseDouble(cursorContactos.getString(3)));
    ...
    public Contactos verContactos(int id){
        ...
        if (cursorContactos.moveToFirst()){
            ...
            contacto.setUser(cursorContactos.getString(1));
            contacto.setProducto(cursorContactos.getString(2));
            contacto.setPrecio(cursorContactos.getDouble(3));
        }
        cursorContactos.close();
